...
namespace sql
{
    ...
    public:
        ...
        string executeCreate(const Command &cmd)
        {
            ...
            indices.primary = new lsm::LSMTree<T>(pName, globalBudget, pPolicy, 1024, pComp, false, 2, 10, nullptr, 10000);
            indices.secondary = new lsm::LSMTree<T>(sName, globalBudget, sPolicy, 24, sComp, true, 2, 10, partStrategy, 10000);
