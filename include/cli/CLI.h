    ...
    public:
              ...
              running(false)
        {
            ...
            for (const string &tableName : existingTables)
            {
                ...
                indices.primary = new lsm::LSMTree<T>(tableName, globalBudget, pPolicy, 1024, pComp, false, 2, 10, nullptr, 10000);
                indices.secondary = new lsm::LSMTree<T>(tableName, globalBudget, sPolicy, 24, sComp, true, 2, 10, partStrategy, 10000);
